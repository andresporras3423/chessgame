...
class BoardData {
  ...
  //   isValid=this.validKnightMove(cell1, cell2);
  // }
  // else if(cell1.piece==="bp"){
  //   isValid=this.validBlackPawnMove(cell1, cell2);
  // }
  // else if(cell1.piece==="wp"){
  //   isValid=this.validWhitePawnMove(cell1, cell2);
  // }
  // else if(cell1.piece==="wb" || cell1.piece==="bb"){
  //   isValid= this.validBishopMove(cell1, cell2);
  // }
  // else if(cell1.piece==="wr" || cell1.piece==="br"){
  //   isValid = this.validRockMove(cell1, cell2);
  //   if(isValid){
